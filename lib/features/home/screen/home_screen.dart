...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<Map<String, dynamic>?> loadTodayStep(String step) async {
    try {
      ...
      debugPrint("Error loading $step: $e");
    }
    return null;
  }
            ...
            children: [
                ...
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: isUserLoading
                        ...
                        ? NetworkImage(userData!['avatar'])
                        : const AssetImage("assets/images/profile_img.png") as ImageProvider,
                    child: isUserLoading ? const CircularProgressIndicator() : null,
                  ),
                  ...
                  Expanded(
                    child: Text(
                      isUserLoading
                          ? "Good Morning"
                          : "Good Morning, ${userData?['name'] ?? ''}",
                      style: TextStyle(fontSize: width * .045, fontWeight: FontWeight.w600),
                    ),
                  ),
                  Stack(
                    children: [
              ...
              GridView.count(
                ...
                children: [
                  ...
                  HomeBox(
                    icon: SvgPicture.asset("assets/images/Vector (3).svg", color: Colors.green),
                    title: "Daily Prayer",
                    subtitle: "Start your day with a guided prayer.",
                    onTap: () {
                  ...
                  HomeBox(
                    icon: SvgPicture.asset("assets/images/Vector (1).svg", color: Colors.green),
                    title: "Daily Devotion",
                    subtitle: "Reflect on today's scripture.",
                    onTap: () {
                  ...
                  HomeBox(
                    icon: SvgPicture.asset("assets/images/Vector (4).svg", color: Colors.green),
                    title: "Today's Actions",
                    subtitle: "Small tasks to grow faith.",
                    onTap: () {
              ...
              //     crossAxisAlignment: CrossAxisAlignment.start,
              //     children: [
              //       Image.asset("assets/images/home_img.jpg", height: height * .2, fit: BoxFit.cover),
              //       SizedBox(height: height * .02),
              //       Text("Explore Life Journeys",
              //           style: TextStyle(fontSize: width * .055, fontWeight: FontWeight.w600)),
              //       SizedBox(height: height * .01),
              //       Text("Find guidance on gratitude, patience or purpose.",
              //           style: TextStyle(color: Colors.grey.shade600)),
              //       SizedBox(height: height * .02),
              //       CustomButton(
              //         text: "view_all_journeys".tr(),
              //         onTap: () => Navigator.pushNamed(context, AppRoutes.journeyScreen),
              //       ),
              //     ],
              //   ),
              // ),
